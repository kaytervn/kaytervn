...
@WebServlet("/exercises/ex7-2/download")
public class DownloadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String url = "/exercises/ex7-2/index.jsp";
		if (action.equals("viewAlbums")) {
			url = "/exercises/ex7-2/index.jsp";
		} else if (action.equals("checkUser")) {
			url = checkUser(request, response);
		} else if (action.equals("viewCookies")) {
			url = "/exercises/ex7-2/view_cookies.jsp";
	...
	private String registerUser(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String url = "/exercises/ex7-2/download/" + product.getCode() + "_download.jsp";
		return url;
	}
	...
	private String checkUser(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (user == null) {
			...
			if (emailAddress == null || emailAddress.equals("")) {
				url = "/exercises/ex7-2/register.jsp";
			}
			...
			// if cookie exists, create User object and go to Downloads page
				...
				session.setAttribute("user", user);
				url = "/exercises/ex7-2/download/" + product.getCode() + "_download.jsp";
			}
		}
