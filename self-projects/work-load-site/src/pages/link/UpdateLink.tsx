  ...
  return (
    <Sidebar2
      breadcrumbs={[
        ...
        {
          label: PAGE_CONFIG.UPDATE_LINK.label,
        },
      ]}
      ...
      renderContent={
        <>
          ...
          <FormCard
            title={PAGE_CONFIG.UPDATE_LINK.label}
            children={
