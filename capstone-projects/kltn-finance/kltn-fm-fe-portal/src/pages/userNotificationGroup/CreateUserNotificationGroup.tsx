...
const CreateUserNotificationGroup = ({ isVisible, formConfig }: any) => {
        ...
        <>
          <div className="flex flex-col space-y-4">
            <SelectField
              ...
              queryParams={{
                ignoreNotificationGroupId: form?.notificationGroupId,
              }}
              labelKey="fullName"
...
export default CreateUserNotificationGroup;
