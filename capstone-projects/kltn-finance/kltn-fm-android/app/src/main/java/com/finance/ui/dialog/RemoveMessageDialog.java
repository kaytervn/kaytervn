...
import com.finance.databinding.DialogRemoveBinding;
...
public class RemoveMessageDialog extends DialogFragment {
    ...
    Dialog dialog;
    public RemoveMessageDialog(String title, DeleteListener listener) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        DialogRemoveBinding binding = DialogRemoveBinding.inflate(requireActivity().getLayoutInflater());
